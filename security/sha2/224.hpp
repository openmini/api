...
#include "../types.hpp"
#include <array>
struct openmini::security::sha::sha2_224 {
	constexpr static std::array<uint32_t,8> initial_state = {0xc1059ed8, 0x367cd507, 0x3070dd17, 0xf70e5939, 0xffc00b31, 0x68581511, 0x64f98fa7, 0xbefa4fa4};
	constexpr static std::array<uint32_t,64> round_constants = {
